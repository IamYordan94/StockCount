-- Insert items and shop-item assignments for Damrak 5 shop
-- This migration adds all items from Damrak 5 shop
...
-- Create shop-item assignments for Damrak 5
-- IJSJES (Ice Cream) - Other category items
INSERT INTO shop_items (shop_id, item_id)
SELECT 
  (SELECT id FROM shops WHERE name = 'Damrak 5'),
  id
FROM items
WHERE name IN (
  'OLA Raket',
